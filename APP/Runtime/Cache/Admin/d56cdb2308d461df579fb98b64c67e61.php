...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" method="post" action="<?php echo U(GROUP_NAME . '/Personal/accountCreate');?>">
		<div class="row cl">
...
<script type="text/javascript" src="__PUBLIC__/main/lib/icheck/jquery.icheck.min.js"></script>
<script type="text/javascript" src="__PUBLIC__/main/lib/jquery.validation/1.14.0/jquery.validate.min.js"></script>
<script type="text/javascript" src="__PUBLIC__/main/lib/jquery.validation/1.14.0/validate-methods.js"></script>
<script type="text/javascript" src="__PUBLIC__/main/lib/jquery.validation/1.14.0/messages_zh.min.js"></script>
...
<script type="text/javascript" src="__PUBLIC__/main/lib/webuploader/0.1.5/webuploader.min.js"></script>
<script type="text/javascript" src="__PUBLIC__/main/lib/ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="__PUBLIC__/main/lib/ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="__PUBLIC__/main/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
